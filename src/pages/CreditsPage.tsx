          ...
          <div className="bg-white border-2 sm:border-3 border-[#3b5998] rounded-[15px] sm:rounded-[20px] p-4 sm:p-8 md:p-10 max-w-[800px] w-full mt-[10vh]">
            ...
            <div className="bg-[#f7f7f7] p-4 sm:p-6 rounded-lg border-l-4 sm:border-l-5 border-l-[#3b5998] mb-6 sm:mb-8">
              <p className="text-[#3b5998] leading-[1.8] text-sm sm:text-base text-justify">
                IPBazaar is a full-stack web application designed to facilitate
                the request and management of IP addresses between users and
                administrators. It features a public-facing landing page, user
                and admin portals, request submission workflows, and an
                integrated email verification system for secure onboarding.
                <br />
                <br />
                Built using a modern monorepo architecture, IPBazaar leverages
                Next.js for the frontend, Node.js + Express.js for the backend,
                and Supabase for database and authentication services. The
                platform supports responsive UI, secure session handling, and
                real-time user interactions, making it scalable, secure, and
                user-friendly.
              </p>
            </div>
